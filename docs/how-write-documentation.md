...
Get real intellij using .tar.gz distribution and configure for screenshot purposes.

Ensure window size:

```
xdotool search --name "graph-examples" windowsize 1280 960
```

IntelliJ:

* Theme: Default
* Application font size: 16
