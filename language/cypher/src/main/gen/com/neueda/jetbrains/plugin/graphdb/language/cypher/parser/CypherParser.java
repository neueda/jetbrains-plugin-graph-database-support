...
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ALIASED_PROCEDURE_RESULT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ANONYMOUS_PATTERN_PART;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ANY_CYPHER_OPTION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.BRACKET_CURLYCLOSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.BRACKET_CURLYOPEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.BRACKET_SQUARECLOSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.BRACKET_SQUAREOPEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.BULK_IMPORT_QUERY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CALL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CASE_ALTERNATIVES;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CASE_EXPRESSION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CLAUSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.COMMAND;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CONFIGURATION_OPTION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CREATE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CREATE_INDEX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CREATE_NODE_PROPERTY_EXISTENCE_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CREATE_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CREATE_UNIQUE_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.CYPHER_OPTION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DASH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DELETE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DIGIT_STRING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DOUBLE_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DROP_INDEX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.DROP_UNIQUE_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ESCAPED_SYMBOLIC_NAME_STRING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.EXPLAIN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.EXPRESSION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.FILTER_EXPRESSION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.FOREACH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.FUNCTION_INVOCATION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.FUNCTION_NAME;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.HINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.IDENTIFIED_INDEX_LOOKUP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ID_IN_COLL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ID_LOOKUP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.INDEX_QUERY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ALL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ALLSHORTESTPATHS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_AND;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ANY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_AS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ASC;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ASCENDING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ASSERT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_BEGIN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_BY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CALL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CASE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_COMMIT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CONSTRAINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CONTAINS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CREATE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CSV;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_CYPHER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_DELETE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_DESC;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_DESCENDING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_DETACH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_DISTINCT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_DROP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ELSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_END;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ENDS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_EXISTS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_EXPLAIN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_EXTRACT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_FALSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_FIELDTERMINATOR;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_FILTER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_FOREACH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_FROM;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_HEADERS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_IN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_INDEX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_IS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_JOIN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_LIMIT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_LOAD;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_MATCH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_MERGE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_NODE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_NONE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_NOT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_NULL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ON;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_OPTIONAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_OR;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_ORDER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_PERIODIC;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_PROFILE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_REDUCE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_REL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_RELATIONSHIP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_REMOVE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_RETURN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_SCAN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_SET;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_SHORTESTPATH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_SINGLE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_SKIP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_START;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_STARTS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_THEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_TRUE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_UNION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_UNIQUE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_UNWIND;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_USING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_WHEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_WHERE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_WITH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_XOR;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.K_YIELD;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LABEL_NAME;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LEFT_ARROW_HEAD;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LIMIT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LIST_COMPREHENSION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LITERAL_IDS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LOAD_CSV;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LOAD_CSV_QUERY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.LOOKUP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.L_DECIMAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.L_IDENTIFIER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.L_IDENTIFIER_TEXT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.L_INTEGER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.L_STRING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.MAP_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.MATCH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.MAYBE_VARIABLE_LENGTH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.MERGE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.MERGE_ACTION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.NODE_LABEL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.NODE_LABELS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.NODE_LOOKUP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.NODE_PATTERN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.NODE_PROPERTY_EXISTENCE_CONSTRAINT_SYNTAX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.NUMBER_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_COLON;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_COMMA;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_DIVIDE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_DOT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_EQUAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_GREATERTHANEQUALS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_GREATHERTHEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_INVALIDNOTEQUALS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_LESSTHANEQUALS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_LESSTHEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_MINUS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_MODULO;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_MUL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_NOTEQUALS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_PIPE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_PLUS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_PLUSEQUALS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_POW;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_QUESTIONSIGN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_RANGE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.OP_REGEXMATCH;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.ORDER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PARAMETER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PARENTHESE_CLOSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PARENTHESE_OPEN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PARENTHESIZED_EXPRESSION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PATTERN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PATTERN_ELEMENT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PATTERN_ELEMENT_CHAIN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PATTERN_PART;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PERIODIC_COMMIT_HINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROCEDURE_ARGUMENTS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROCEDURE_NAME;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROCEDURE_NAMESPACE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROCEDURE_OUTPUT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROCEDURE_RESULT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROCEDURE_RESULTS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROFILE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROPERTIES;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROPERTY_EXPRESSION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROPERTY_KEY_NAME;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.PROPERTY_LOOKUP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.QUERY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.QUERY_OPTIONS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RANGE_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.REGULAR_QUERY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIPS_PATTERN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIP_DETAIL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIP_LOOKUP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIP_PATTERN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIP_PATTERN_SYNTAX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT_SYNTAX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RELATIONSHIP_TYPES;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.REL_TYPE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.REL_TYPE_NAME;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.REMOVE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.REMOVE_ITEM;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RETURN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RETURN_BODY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RETURN_ITEM;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RETURN_ITEMS;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.RIGHT_ARROW_HEAD;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SEMICOLON;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SET_CLAUSE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SET_ITEM;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SHORTEST_PATH_PATTERN;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SIGNED_DECIMAL_INTEGER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SIGNED_INTEGER_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SIMPLE_PROCEDURE_RESULT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SINGLE_QUERY;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SKIP;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SORT_ITEM;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.START;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.START_POINT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.STATEMENT;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.STATEMENT_ITEM;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.STRING_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.SYMBOLIC_NAME_STRING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.UNESCAPED_SYMBOLIC_NAME_STRING;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.UNION;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.UNIQUE_CONSTRAINT_SYNTAX;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.UNSIGNED_DECIMAL_INTEGER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.UNSIGNED_INTEGER_LITERAL;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.UNWIND;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.VARIABLE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.VERSION_NUMBER;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.WHERE;
import static com.neueda.jetbrains.plugin.graphdb.language.cypher.psi.CypherTypes.WITH;
...
public class CypherParser implements PsiParser, LightPsiParser {
  ...
  public static boolean AliasedProcedureResult(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<aliased procedure result>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  public static boolean ConfigurationOption(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<configuration option>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  // "[" Expression? ("," Expression)* "]"
  private static boolean Expression1_9(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Expression1_9")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, BRACKET_SQUAREOPEN);
    r = r && Expression1_9_1(b, l + 1);
    r = r && Expression1_9_2(b, l + 1);
  ...
  // Expression?
  private static boolean Expression1_9_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Expression1_9_1")) return false;
    Expression(b, l + 1);
    return true;
  }

  // ("," Expression)*
  private static boolean Expression1_9_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Expression1_9_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!Expression1_9_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "Expression1_9_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // "," Expression
  private static boolean Expression1_9_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Expression1_9_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, OP_COMMA);
    r = r && Expression(b, l + 1);
  ...
  public static boolean ProcedureName(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<procedure name>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  public static boolean ProcedureOutput(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<procedure output>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  public static boolean ProcedureResult(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<procedure result>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  private static boolean RelationshipPatternSyntax_0(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, BRACKET_SQUAREOPEN);
    r = r && Variable(b, l + 1);
    r = r && RelType(b, l + 1);
    r = r && consumeToken(b, BRACKET_SQUARECLOSE);
    r = r && consumeToken(b, OP_MINUS);
  ...
  private static boolean RelationshipPatternSyntax_1(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, BRACKET_SQUARECLOSE);
    r = r && consumeToken(b, OP_MINUS);
    r = r && consumeToken(b, OP_GREATHERTHEN);
    r = r && consumeToken(b, PARENTHESE_OPEN);
    r = r && consumeToken(b, PARENTHESE_CLOSE);
    exit_section_(b, m, null, r);
    return r;
  ...
  private static boolean RelationshipPatternSyntax_2(PsiBuilder b, int l) {
    ...
    r = consumeToken(b, PARENTHESE_OPEN);
    r = r && consumeToken(b, PARENTHESE_CLOSE);
    r = r && consumeToken(b, OP_LESSTHEN);
    r = r && consumeToken(b, OP_MINUS);
    r = r && consumeToken(b, BRACKET_SQUAREOPEN);
    r = r && Variable(b, l + 1);
    r = r && RelType(b, l + 1);
  ...
  public static boolean SimpleProcedureResult(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<simple procedure result>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  public static boolean SymbolicNameString(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<symbolic name string>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
  ...
  public static boolean Variable(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<variable>", L_IDENTIFIER, L_IDENTIFIER_TEXT)) return false;
    boolean r;
