...
public class UserFunctionCompletionTest extends BaseCompletionTest {
    ...
    public void testContainsTestUserFunction() throws Exception {
        ...
        assertThat(strings)
                .contains(
                        "com.neueda.jetbrains.plugin.graphdb.test.database.neo4j_3_5.firstTestFunction",
                        "com.neueda.jetbrains.plugin.graphdb.test.database.neo4j_3_5.secondTestFunction"
                );
    }
    ...
    public void testCompletionCaretAfterParentheses() throws Exception {
        ...
        myFixture.checkResult("RETURN com.neueda.jetbrains.plugin.graphdb.test.database.neo4j_3_5.firstTestFunction()<caret>");
    }
    ...
    public void testCompletionCaretAtParentheses() throws Exception {
        ...
        myFixture.completeBasic();
        myFixture.finishLookup(Lookup.REPLACE_SELECT_CHAR);
        myFixture.checkResult("RETURN com.neueda.jetbrains.plugin.graphdb.test.database.neo4j_3_5.secondTestFunction(<caret>)");
    }
}
